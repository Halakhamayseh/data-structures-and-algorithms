...
const replaceZeros = (string) => {
  // Solution code here...
  let rejex = /0/g;
  return string.replace(rejex,'zero');
};
...
------------------------------------------------------------------------------------------------ */
//https://stackoverflow.com/questions/36163026/regex-dealing-with-dots-within-words//we read abou it
